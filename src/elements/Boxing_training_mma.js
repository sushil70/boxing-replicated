...
const BoxingTrainingMma = (props) => {
  ...
  return (
    ...
    {pagedata.map((item, i) => {
                    return (
      <div className="videos1"> <img src={item.image} className="videos1img" alt /> <Link to={item.youtubevideolink}><img src= "assets/img/play.png" className="play_icon" alt />                           </Link>
