    ...
    <div className="mvpBgContainer mvp_container" id="newsMainContents">
     ...
     <div className="service_content" style={{minHeight: 49}}>
      <div className="contentData">
       <h1 className="contentBreadcrumb2">expertise&nbsp;&gt;&nbsp;talent rep.&nbsp;&gt;&nbsp;boxing</h1>
      <meta itemProp="serviceType" content="talent rep." />
      <div style={{margin: '25px 0 25px 0'}}>
        <img className=" lazyloaded" alt="Talent Representation" data-src="assets/images//serviceimages/image-8.jpg" style={{width: '100%', height: 'auto'}} src="assets/images/serviceimages/image-8.jpg" />
      </div>
      <div className="pageTag">Masson, LLC Sports Consulting Division</div>
      <p>Masson, LLC represents some of the most influential and well-known athletes within the sport of boxing.
