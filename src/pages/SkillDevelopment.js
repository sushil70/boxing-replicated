  ...
  <div className="news_articles_content" itemScope itemType="https://schema.org/Article" style={{width: '100%'}}>
    <div className="left_content_area" style={{margin: 0}}>
      <h1 className="titles_article border_titles_article1">
        <span itemProp="name">Boxing Skill Development Training | Defensive Skills in Boxing | Manny Masson | MVP Boxing</span>            <Link className="advisor-cta-booking float-right" to="/contact">
          <div className="icon-label">BOOK NOW</div>
        </Link>
        <div className="socialInfo">
          <div className="left w-100">mvpboxing                    &nbsp;|&nbsp;
            <i className="fa fa-clock-o" aria-hidden="true" />&nbsp;April 05, 2019, 04:42AM              </div>
          <div className="clear" />
        </div>{/* ends (.socialInfo) */}
      </h1>
      <div className="workout_content update-workout_content mvp-fit">
        <div style={{margin: '25px 0 25px 0'}}>
          <img src="/assets/userfiles/images/skills.jpg" style={{width: '100%', height: 'auto'}} />
        </div>
        <div className="row mx-0 my-2 advisor-contact">
          <div className="col-12">
            <p>Boxing skill development training | defensive skills in boxing | manny masson | mvp boxing is available year-round, with programs for everyone from the novice athlete to
              the aspiring pro. See below for how to select and book the workout of your choice through our
              quick and easy online registration process.</p>
          </div>
          <div className="col-12">
            <div className="advisor-cta-holder text-center">
              <div className="row mx-0 w-100">
                ...
                <div className="col-12">
                  <div className="advisor-cta-headline">Connect with Us</div>
                </div>
                <div className="col-12">
                  <div className="advisor-cta-description">Specialists are standing by to help you</div>
                </div>
                <div className="col-12 text-center no-padding mt-2">
                  <div className="row mx-0">
                    <a className="advisor-cta-call col-4" href="tel:312-399-5390">
                      <div className="icon-phone"><i className="fa fa-phone" aria-hidden="true" /></div>
                      <div className="icon-label">speak to an advisor</div>
                    </a>
                    <Link className="advisor-cta-chat col-4" to="/contact">
                      <div className="icon-message-bulb-square-o"><i className="fa fa-comment-alt" aria-hidden="true" /></div>
                      <div className="icon-label">chat with an advisor</div>
                    </Link>
                    <a className="advisor-cta-email col-4" href="mailto:info@mvpboxing.com">
                      <div className="icon-envelope-o"><i className="fa fa-envelope" aria-hidden="true" /></div>
      ...
      <div className="socialInfo"><div className="text-center social-sharing-info bottom-social-share">
