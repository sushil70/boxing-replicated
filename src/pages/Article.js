...
const Article = (props) => {
  ...
  return (
    <div className="mvpBgContainer mvp_container" id="newsMainContents">
        ...
        <h1 itemProp="name" className="titles_article ">{pagedata.page_title}</h1>
        <div className="workout_content text-justify page-loader">
        <Loader loading={loading} />
        <div dangerouslySetInnerHTML={{ __html: pagedata.content }} />
        </div>
        <div dangerouslySetInnerHTML={{ __html: pagedata.additional_content }} />
        <div>
        <div className="page__links" style={{marginBottom: 10}}>
          <h3 className="page__links__title" />

          <Link to="/contact" className="page__links__link btn feat-link" target="_self">
