...
const EspanolMma = (props) => {
  ...
  useEffect(() => {
    async function getData(currentPage) {
      setLoading(true)
      let apiUrl = 'espanolmma?p='+currentPage;
  ...
  <div className="news_articles_content">
    <div className="left_content_area odds_section">
      ...
      <ul className="sch_tabs">
        <li className="ml-3 p-1"><Link to="/espanol-boxeo">Boxeo</Link></li>
        <li className="ative_tab p-1"><Link to="/espanol-amm">AMM</Link></li>
      </ul>
      <div className="top_pager d-none d-md-block">
        <div className="left news_prev_post">
          <Link to="/espanol-amm" className="margin-left-0 previousPage">
            <div className="odds_arrow_left left" />Previo </Link>
          <Link className="margin-left-1 nextPage" to="/espanol-amm">Próximo<div className="odds_arrow_right right" /></Link>
        </div>
        <div className="clear" />
      </div>
      <div className="news_data_container">
                ...
                return (
                  ...
                  <div className="clear-left mr15 row mx-1">
                      <p className="box-img col-3 col-md-2 pl-1 pr-0">
                        <em itemProp="datePublished">{item.datecreated}</em><em className="comment-count-block"><i className="fa fa-comment" />&nbsp;&nbsp;<span className="comment-count">0</span></em></p>
        ...
        <div className="top_pager">
          <div className="right news_prev_post">
            <Link to="/espanol-amm" className="margin-left-0 previousPage">
              <div className="odds_arrow_left left " />Previo </Link>
            <Link to="/espanol-amm" style={{display: 'flex'}} className='nextPage'>Próximo<div className="odds_arrow_right right nextPage" /></Link>
          </div>
          <div className="clear" />
        </div>
      </div>
