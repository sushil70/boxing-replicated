  ...
  <div className="news_articles_content" itemScope itemType="https://schema.org/Article" style={{width: '100%'}}>
    <div className="left_content_area" style={{margin: 0}}>
      <h1 className="titles_article border_titles_article1">
        <span itemProp="name">Athlete Assesment Sessions and Assesment Form | Manny Massion | MVP Boxing</span>            <Link className="advisor-cta-booking float-right" to="/contact">
          <div className="icon-label">BOOK NOW</div>
        </Link>
        <div className="socialInfo">
          <div className="left w-100">mvpboxing                    &nbsp;|&nbsp;
            <i className="fa fa-clock-o" aria-hidden="true" />&nbsp;April 05, 2019, 06:37AM              </div>
          <div className="clear" />
        </div>{/* ends (.socialInfo) */}
      </h1>
      <div className="workout_content update-workout_content mvp-fit">
        <div style={{margin: '25px 0 25px 0'}}>
          <img src="/assets/userfiles/images/athlete_assessment.jpg" style={{width: '100%', height: 'auto'}} />
        </div>
        <div className="row mx-0 my-2 advisor-contact">
          <div className="col-12">
            <p>Athlete assesment sessions and assesment form | manny massion | mvp boxing is available year-round, with programs for everyone from the novice athlete to
