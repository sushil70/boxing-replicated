...
const ThaiBoxing = (props) => {
  ...
  <div className="left_content_area" style={{margin: 0}}>
    <h1 className="titles_article border_titles_article1">
      Thai Boxing workout            <div className="socialInfo">
        <div className="left">mvpboxing&nbsp;|&nbsp;<i className="fa fa-clock-o" aria-hidden="true" />&nbsp;August 23, 2019, 06:15PM              </div>
        <div className="clear" />
      </div>{/* ends (.socialInfo) */}
    </h1>
    <div className="workout_content update-workout_content headline-articles" style={{minHeight: 844}}>
      <div style={{margin: '25px 0 25px 0'}}>
        <img src="/assets/menusImg/e3a3d53b49939c276fa7f21f1e3fdb3a.JPG" style={{width: '100%', height: 'auto'}} />
      </div>
      <div id="accordion" className="accordion">
        <div className="card mb-1">
          ...
          <div id="collapse0" className="collapse show" aria-labelledby="heading0" data-parent="#accordion">
            <div className="card-body">
              <p>Thai-boxing, the national sport of Thailand, is perhaps the most brutal sport in existence. Participants batter each other with punches, kicks, knees and elbows. There are few rules in Thai-boxing and boils down to survival of the fittest. A match consists of five, three minute rounds. Punching, knee and elbow strikes and kicking techniques are allowed to any part of the body, except the groin. Because of the hard, fast paced action, it is very important for the fighters to be highly conditioned, both physically and mentally. A fighter entering the ring in anything but top condition can expect, at the very least, to be knocked unconscious. There is also a chance of death if not properly prepared. In Thailand, there are many deaths each year as a result of the beating taken in the ring.</p>
              <p>Much of the Thai-boxers conditioning is done on the Thai-pads. Thai-pads are solid, heavy pads strapped to the arms of a holder. This method of training is advantageous to the heavy bag in that it allows the fighter to respond to a "live" opponent. The holders job varies, depending on the desired results of the training session. For some drills, the holder attacks with kicks to the legs, body or head, and punches to the body and head. While defending himself, the fighter throws his own kicks, knees and elbows. Using another method, the holder remains relatively stationary and allows the fighter to attack with a pre-designated combination or a free flow barrage of kicks, knees, and elbows.</p>
            </div>
          </div>
        </div>
        <div className="card mb-1">
        ...
        <div className="card mb-1">
          ...
          <div id="collapse18" className="collapse" aria-labelledby="heading18" data-parent="#accordion">
            <div className="card-body">
              <p>Periodization is based on the theory that hard, high intensity work over extended periods of time can lead to burnout, injury and stagnation. Better progress can be made following a periodization schedule schedule. The periodization cycle can be found in Appendix D for weight training and in Appendix E for Thai-pads.</p>
            </div>
          </div>
        </div>
        <div className="card mb-1">
        ...
        <div className="card mb-1">
          ...
          <div id="collapse19" className="collapse" aria-labelledby="heading19" data-parent="#accordion">
            <div className="card-body">
              <p>4 minutes, easy kicks. 4 minutes, recovery, stretching. 2 minutes, easy Form, kicks, knees and elbows. 2 minutes, recovery.</p>
            </div>
          </div>
        </div>
        <div className="card mb-1">
          ...
          <div id="collapse19" className="collapse" aria-labelledby="heading19" data-parent="#accordion">
            <div className="card-body">
              <p>8 sec. easy, 8 sec. full speed, 24 sec. rest, 4 rounds. 1 minute rest GUTBUSTERS 10 sec. full speed, 30 sec. rest, 4 rounds. 3 minutes rest.</p>
            </div>
          </div>
        </div>
        <br />
