...
<div className="article_area_content">
  <h1 className="titles_article border_titles_article">PHYSICAL &amp; MENTAL BENEFITS</h1>
      ...
      <div id="accordion" className="accordion">
        <div className="card mb-1">
          ...
          <div id="collapse0" className="collapse show" aria-labelledby="heading0" data-parent="#accordion">
            <div className="card-body">
              <strong>Sharing knowledge and helping others reach the full extent of their potential is what we do best.</strong><br /><br />
              This is why Manny Masson has developed proven teaching methods that will not only help you learn quickly and easily but also provide a wide range of benefits for students of all ages.
            </div>
          </div>
        </div>
        <div className="card mb-1">
          ...
          <div id="collapse1" className="collapse" aria-labelledby="heading1" data-parent="#accordion">
            <div className="card-body">
              <ul className="pl-1">
                <li><i className="fa fa-check-square-o" aria-hidden="true" />&nbsp;Improved reflexes and coordination</li>
                <li><i className="fa fa-check-square-o" aria-hidden="true" />&nbsp;Increased speed and power</li>
                <li><i className="fa fa-check-square-o" aria-hidden="true" />&nbsp;Increased energy level</li>
                <li><i className="fa fa-check-square-o" aria-hidden="true" />&nbsp;Improved appearance and muscle tone</li>
                <li><i className="fa fa-check-square-o" aria-hidden="true" />&nbsp;Increased strength and stamina</li>
                <li><i className="fa fa-check-square-o" aria-hidden="true" />&nbsp;Better balance and body awareness</li>
                <li><i className="fa fa-check-square-o" aria-hidden="true" />&nbsp;Improved flexibility</li>
                <li><i className="fa fa-check-square-o" aria-hidden="true" />&nbsp;Weight loss and control</li>
                <li><i className="fa fa-check-square-o" aria-hidden="true" />&nbsp;Better health and longevity</li>
              </ul>
            </div>
          </div>
        </div>
        <div className="card mb-1">
          ...
          <div id="collapse2" className="collapse" aria-labelledby="heading2" data-parent="#accordion">
            <div className="card-body">
              <ul className="pl-1">
                <li><i className="fa fa-check-square-o" aria-hidden="true" />&nbsp;Improved self-image and self-esteem</li>
                <li><i className="fa fa-check-square-o" aria-hidden="true" />&nbsp;Increased self-confidence and positive attitude</li>
                <li><i className="fa fa-check-square-o" aria-hidden="true" />&nbsp;Greater self-discipline and a "can do" attitude</li>
                <li><i className="fa fa-check-square-o" aria-hidden="true" />&nbsp;Improved concentration, work and study habits</li>
                <li><i className="fa fa-check-square-o" aria-hidden="true" />&nbsp;Stress reduction and increased levels of relaxation</li>
              </ul>
            </div>
          </div>
        </div>
        <div className="card mb-1">
          ...
          <div id="collapse3" className="collapse" aria-labelledby="heading3" data-parent="#accordion">
            <div className="card-body">
              Know that you possess the knowledge that you are able to protect yourself and your loved ones should a life threatening situation arise.
            </div>
          </div>
        </div>
      </div>
