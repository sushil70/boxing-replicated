      ...
      <div className="videos-block">
        ...
        <div className="videos-alt podcast">
          ...
          <div className="arrows">
            <Link to="/podcasts/boxing/317"><i className="fa prev-arrow fa-caret-square-o-left" aria-hidden="true" /></Link>
            <Link to="/podcasts/mma/285"><i className="fa prev-arrow fa-caret-square-o-right" aria-hidden="true" /></Link>
          </div>
          <Loader loading={loading} />
          ...
          <div className="slick-dots">
            ...
            <Link to="/podcasts/boxing/317"><i className="fa fa-circle active" aria-hidden="true" /></Link>
            <Link to="/podcasts/mma/285"><i className="fa fa-circle  " aria-hidden="true" /></Link>
          </div>
