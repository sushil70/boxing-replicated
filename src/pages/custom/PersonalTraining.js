...
<div className="news_articles_content" itemScope itemType="https://schema.org/Article">
  <div className="left_content_area">
    <h1 className="titles_article border_titles_article1">
      <span itemProp="name">Personal Training</span>            <div className="socialInfo">
        <div className="left">mvpboxing                                    &nbsp;|&nbsp;
          <i className="fa fa-clock-o" aria-hidden="true" />&nbsp;March 28, 2018, 07:33PM              </div>
        <div className="clear" />
      </div>{/* ends (.socialInfo) */}
    </h1>
    <div className="workout_content update-workout_content">
      <div style={{margin: '25px 0 25px 0'}}>
        <img src="/assets/userfiles/images/personaltrainer.jpg" style={{width: '100%', height: 'auto'}} />
      </div>
      <div id="accordion" className="accordion">
        <div className="card mb-1">
          ...
          <div id="collapse0" className="collapse show" aria-labelledby="heading0" data-parent="#accordion">
            <div className="card-body">
              <ul className="pl-1">
                <li><i className="fa fa-check-square-o" aria-hidden="true" />&nbsp;A qualified and properly trained personal trainer may assist you in safely starting and maintaining a sustainable an effective and efficient exercise program.&nbsp;</li>
                <li><i className="fa fa-check-square-o" aria-hidden="true" />&nbsp;A personal trainer will understand your “fitness goals” and help you achieve them in an effective and injury free approach.&nbsp;</li>
                <li><i className="fa fa-check-square-o" aria-hidden="true" />&nbsp;A personal trainer can be a great source of motivation and encouragement, as well as a resource for the latest objective health and fitness information.&nbsp;</li>
                <li><i className="fa fa-check-square-o" aria-hidden="true" />&nbsp;A personal trainer may also help you fit exercise into your busy schedule and teach you how to effectively maximize your time in the gym.</li>
              </ul>
            </div>
          </div>
        </div>
        <div className="card mb-1">
          ...
          <div id="collapse1" className="collapse" aria-labelledby="heading1" data-parent="#accordion">
            <div className="card-body">
              <p>We provide high quality personal fitness training and boxing instruction in the following:</p>
              <ul className="pl-1">
                <li><i className="fa fa-check-square-o" aria-hidden="true" />&nbsp;At the beginning of your personal training journey we conduct a full scale audit of dietary habits and make positive recommendations that are particular to how you eat, rather than making sweeping statements that may apply generally, but not necessarily to you specifically..&nbsp;</li>
                <li><i className="fa fa-check-square-o" aria-hidden="true" />&nbsp;One-on-One Personal Fitness Training (weight loss, strength improvement, sports performance).&nbsp;</li>
                <li><i className="fa fa-check-square-o" aria-hidden="true" />&nbsp;One-on-One Boxing Training</li>
                <li><i className="fa fa-check-square-o" aria-hidden="true" />&nbsp;Small Group Fitness and Boxing Training</li>
              </ul>
            </div>
          </div>
        </div>
        <div className="card mb-1">
          ...
          <div id="collapse2" className="collapse" aria-labelledby="heading2" data-parent="#accordion">
            <div className="card-body">
              <p>Manny Masson, is a professional who is dedicated to instructional excellence at all levels. Manny has earned a Bachelor of Science degree in Business Administration and Sports Science from University of Wisconsin.</p>
              <p>He's trained and developed fighters that have competed at the elite level in their respective sports which have become world boxing champions in both the amateur, (2004 Athens Olympic Games) and professional level. Listed below are world champions developed and trained by Manny Masson.</p>
              <ul className="pl-1">
                <li><i className="fa fa-check-square-o" aria-hidden="true" />&nbsp;Raul 'El Diamanté' Marquez</li>
                <li><i className="fa fa-check-square-o" aria-hidden="true" />&nbsp;Sam 'Nigerian Nightmare' Peter</li>
                <li><i className="fa fa-check-square-o" aria-hidden="true" />&nbsp;Yuriorkis 'El Ciclon de Guantanamo' Gamboa</li>
                <li><i className="fa fa-check-square-o" aria-hidden="true" />&nbsp;Odlanier 'La Sombra' Solis</li>
                <li><i className="fa fa-check-square-o" aria-hidden="true" />&nbsp;Sinan Şamil Sam</li>
                <li><i className="fa fa-check-square-o" aria-hidden="true" />&nbsp;Zahir Raheem</li>
                <li><i className="fa fa-check-square-o" aria-hidden="true" />&nbsp;Herbie Hyde</li>
                <li><i className="fa fa-check-square-o" aria-hidden="true" />&nbsp;Greg 'The Eagle' Soszynski</li>
              </ul>
            </div>
          </div>
        </div>
    ...
    <div className="page__links" style={{marginBottom: 10}}>
      ...
      <a className="page__links__link btn feat-link" target="_self" href="https://www.mvpboxing.com/contact-us">
