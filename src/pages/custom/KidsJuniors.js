...
<div className="news_articles_content" itemScope itemType="https://schema.org/Article">
  <div className="left_content_area">
    <h1 className="titles_article border_titles_article1">
      <span itemProp="name">Kids and Juniors Boxing Training | Personal Boxing Trainer | Manny Masson | MVP Boxing</span>            <div className="socialInfo">
        <div className="left">MVPBOXING.COM                                    &nbsp;|&nbsp;
          <i className="fa fa-clock-o" aria-hidden="true" />&nbsp;August 09, 2019, 10:32PM              </div>
        <div className="clear" />
      </div>{/* ends (.socialInfo) */}
    </h1>
    <div className="workout_content update-workout_content">
      <div style={{margin: '25px 0 25px 0'}}>
        <img src="/assets/userfiles/images/kid1.jpg" style={{width: '100%', height: 'auto'}} />
      </div>
        ...
        <div className="card mb-1">
          ...
          <div id="collapse0" className="collapse show" aria-labelledby="heading0" data-parent="#accordion">
            <div className="card-body">
              <p>Discipline, self-confidence, respect, integrity, commitment, responsibility, leadership qualities and personal drive and motivation are some of the core principles for success in sports and in all aspects of life. The aforementioned core values, however, are rarely taught to children in a structured school environment. The practice of combat sports is seen as a means to individual physical and mental development, and our ‘Kids and Juniors Program’ emphasize development of these important life skills.</p>
            </div>
          </div>
        </div>
        <div className="card mb-1">
          <a className="text-left header" data-toggle="collapse" data-target="#collapse1" aria-expanded="true" aria-controls="collapse1">
            <div className="card-header" id="heading1">
              <h5 className="mb-0 question">
                <strong>The kids and juniors Boxing and BJJ programs are designed to:</strong>
          ...
          <div id="collapse1" className="collapse" aria-labelledby="heading1" data-parent="#accordion">
            <div className="card-body">
              <ul className="pl-1">
                <li><i className="fa fa-check-square-o" aria-hidden="true" />&nbsp;Teach a comprehensive self-defense system that will give children a high degree of self-confidence.</li>
                <li><i className="fa fa-check-square-o" aria-hidden="true" />&nbsp;Teach children how to protect themselves against bullies and intelligently cope with peer pressure.</li>
                <li><i className="fa fa-check-square-o" aria-hidden="true" />&nbsp;Teach core values such as respect, humility, dignity and honesty.</li>
              </ul>
              <p>We offer instructional classes for kids and teach them in a fun manner. The kid's program integrates self-defense techniques with physical conditioning drills and skill oriented games aimed at improving your child's coordination, rhythm, focus, motor skills, agility, flexibility and range of motion.</p>
            </div>
          </div>
        </div>
