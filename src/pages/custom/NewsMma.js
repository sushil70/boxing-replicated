  ...
  <div className="news_articles_content">
    <div className="left_content_area odds_section">
      ...
      <ul className="sch_tabs">
        <li className="p-1"><Link to="/news-boxing">Boxing</Link></li>
        <li className="ative_tab ml-3 p-1"><Link to="/news-mma">MMA</Link></li>
      </ul>
      <div className="top_pager d-none d-md-block">
        <div className="left news_prev_post">
          <Link to="/news-mma" className="margin-left-0 previousPage">
            <div className="odds_arrow_left left" />Prev</Link>
          <Link className="margin-left-1 nextPage" to="/news-mma">Next<div className="odds_arrow_right right" /></Link>
        </div>
        <div className="clear" />
      </div>
      <div className="news_data_container">
        ...
        <div className="top_pager">
          <div className="right news_prev_post">
            <Link to="/news-mma" className="margin-left-0 previousPage">
              <div className="odds_arrow_left left" />Prev</Link>
            <Link to="/news-mma" style={{display: 'flex'}} className='nextPage'>Next<div className="odds_arrow_right right" /></Link>
          </div>
          <div className="clear" />
        </div>
      </div>
