...
const Max = (props) => {
  ...
  <div className="news_articles_content" itemScope itemType="https://schema.org/Article">
    <div className="left_content_area">
      <h1 className="titles_article border_titles_article1">
        <span itemProp="name">VO2 Max Values: How to Measure by Age, Gender, and Altitude | MVP Boxing</span>            <div className="socialInfo">
          <div className="left">Elizabeth Quinn                                    &nbsp;|&nbsp;
      ...
      <div className="workout_content update-workout_content">
        <div style={{margin: '25px 0 25px 0'}}>
          <img src="/assets/userfiles/images/vo2_max.jpg" style={{width: '100%', height: 'auto'}} />
        </div>
        <div id="accordion" className="accordion">
          <div className="card mb-1">
            ...
            <div id="collapse0" className="collapse show" aria-labelledby="heading0" data-parent="#accordion">
              <div className="card-body">
                <p>VO2 max, also known as maximal oxygen uptake, is the measurement of the maximum amount of oxygen a person can utilize during intense exercise. It is a common measurement used to establish the aerobic endurance of an athlete prior to or during the course of training. It is one of several tests used to determine an athlete's cardiovascular fitness and performance capacity.</p>
                <p>VO2 max is measured in milliliters of oxygen used in one minute per kilogram of body weight (mL/kg/min). It is based on the premise that the more oxygen an athlete consumes during high-level exercise, the more the body will generate adenosine triphosphate (ATP) energy in cells. ATP is often referred to as the "molecular unit of currency" of intracellular energy,</p>
                <p>VO2 max should not be confused with the lactate threshold (LT) testing, which refers to the point during high-intensity exercise where lactate builds up in the muscles faster than it can be removed.</p>
              </div>
            </div>
          </div>
          <div className="card mb-1">
            ...
            <div id="collapse1" className="collapse" aria-labelledby="heading1" data-parent="#accordion">
              <div className="card-body">
                <p>VO2 max is typically conducted in a sports performance lab. It is most often graded, meaning that the intensity is carefully calibrated and increased over time.</p>
                <p>Either a treadmill or stationary bicycle may be used. Prior to the test, you would be outfitted with a face mask that is connected to a machine which can analyze your respiratory rate and volume alongside the concentration of oxygen and carbon dioxide in inhaled and exhaled air. A heart strap would be worn around your chest to measure your heart rate.?</p>
                <p>The test usually takes between 10 and 20 minutes. To prepare for the test, you would need to:</p>
                <ul><li>Dress in comfortable workout clothes.</li><li>Refrain from exercise or training 24 hours prior to the test.</li><li>Avoid food, alcohol, tobacco, and caffeine for at least three hours prior to testing.</li></ul>
                <p>VO2 max is reached when your oxygen consumption remains at a steady state despite an increase in the workload. It is at this plateau that the athlete moves from aerobic metabolism to anaerobic metabolism. From there, it is usually not long before muscle fatigue sets in and forces the athlete to stop exercising.?</p>
              </div>
            </div>
          </div>
          <div className="card mb-1">
            ...
            <div id="collapse2" className="collapse" aria-labelledby="heading2" data-parent="#accordion">
              <div className="card-body">
                <p>The VO2 max values can be used to establish your baseline fitness level before the start of a training program and used thereafter to track your progress.</p>
                <p>The algorithm used to calculate your score can vary, although the one widely used for commercial applications is called the FirstBeat method. Introduced in 2012, the FirstBeat method measures your VO2 max value based on a linear relationship between oxygen consumption and running (or cycling) speed.</p>
                <p>Other methods of calculation include the Cooper test, designed for the U.S. Air Force in the 1960s, and the Uth-Sørensen-Overgaard-Pedersen estimation, which factors in your resting heart rate (RHR) and maximum heart rate (MHR).</p>
                <p>Broadly speaking, VO2 max values are characterized in men and women as follows:</p>
                <figure id="mntl-sc-block_1-0-27" className="comp mntl-sc-block mntl-sc-block-table">
                  <div className="mntl-sc-block-table__table-wrapper">
                    <table className="mntl-sc-block-table__table text-center" style={{textAlign: 'center'}}>
                      ...
                      <thead>
                        <tr>
                          <th colSpan={7} className="mntl-sc-block-table__title text-center">VO2 Max Norms for Men </th>
                        </tr>
                      </thead>
                      <tbody data-check={-1}>
                        <tr>
                ...
                <div id="mntl-sc-block_1-0-28" className="comp mntl-sc-block mntl-sc-block-adslot mntl-block" />
                <figure id="mntl-sc-block_1-0-30" className="comp mntl-sc-block mntl-sc-block-table">
                  <div className="mntl-sc-block-table__table-wrapper">
                    <table className="mntl-sc-block-table__table text-center" style={{textAlign: 'center'}}>
                      <colgroup style={{}} span={1} />
                      <colgroup style={{}} span={1} />
                      ...
                      <thead>
                        <tr>
                          <th colSpan={7} className="mntl-sc-block-table__title text-center">VO2 Max Norms for Women</th>
                        </tr>
                      </thead>
                      <tbody data-check={-1}>
                        <tr>
          ...
          <div className="card mb-1">
            ...
            <div id="collapse3" className="collapse" aria-labelledby="heading3" data-parent="#accordion">
              <div className="card-body">
                <p>The average sedentary male will achieve a VO2 max of approximately 35 to 40 mL/kg/min. The average sedentary female will score a VO2 max of between 27 an 30 mL/kg/min.</p>
                <p>These scores can improve with training but may be limited by certain factors. Among them:</p>
                <ul><li><strong>Age</strong> plays a central role with VO2 max scores typically peaking by age 20 and declining by nearly 30 percent by age 65.</li><li><strong>Gender </strong>also contributes with elite female athletes typically having higher VO2 max values than their male counterparts. However, when values are adjusted based on body size, blood volume, and hemoglobin content, a man's VO2 max will generally be 20 percent higher than a woman's.</li><li><strong>Altitude</strong> contributes simply because there is less air to consume at higher altitudes. As such, an athlete will generally have a five percent decrease in VO2 max results for every 5,000 feet gained in altitude.?</li></ul>
                <p>Higher VO2 max scores are associated with certain endurance sports, most specifically cycling, rowing, distance running, and cross-country skiing. Tour de France winner Miguel Indurain's VO2 max was reported at 78 mL/kg/min during the peak of his conditioning, while cross-country skier Bjørn Dæhlie reportedly achieved a VO2 max of 96 mL/kg/min.?</p>
              </div>
            </div>
          </div>
        </div>
