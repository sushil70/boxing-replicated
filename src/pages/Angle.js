  ...
  <div className="news_articles_content" itemScope itemType="https://schema.org/Article" style={{width: '100%'}}>
    <div className="left_content_area" style={{margin: 0}}>
      <h1 className="titles_article border_titles_article1">
        <span itemProp="name">Womens Sports Injuries | MVP Boxing</span>            <div className="socialInfo">
          <div className="left">MVPBOXING.COM                                    &nbsp;|&nbsp;
            <i className="fa fa-clock-o" aria-hidden="true" />&nbsp;March 28, 2018, 04:08PM              </div>
          <div className="clear" />
        </div>{/* ends (.socialInfo) */}
      </h1>
      <div className="workout_content update-workout_content">
        <div style={{margin: '25px 0 25px 0'}}>
          <img src="/assets/userfiles/images/womans_injuries.jpg" style={{width: '100%', height: 'auto'}} />
        </div>
          ...
          <div className="card mb-1">
            ...
            <div id="collapse0" className="collapse show" aria-labelledby="heading0" data-parent="#accordion">
              <div className="card-body">
                <p><strong>Definition and Occurrence</strong></p>
                <ol type="i" className="pl-1">
                  <li>Due to biomechanical differences, women are more susceptible to sports related injuries than men. The main difference is a woman’s wider pelvis; this female characteristic has been linked to what’s known as a larger Q-angle (Quadriceps Angle).</li>
                  <li>The Q-angle is the angle at which the femur (upper leg bone) meets the tibia (lower leg bone). This is measured by creating two intersecting lines; one of these lines is from the center of the patella (knee cap) to the anterior superior iliac spine of the pelvis (the part of the pelvis you can feel on the side of your lower abdomen). The other line initiates from the patellar tendon to the tibial tuberosity (on the tibia just below the knee).</li>
                  <li>The Q-angle is best measured by standing, because it replicates the normal weight-bearing forces applied to the knee joint during routine activity. A normal range for the Q-angle while standing is between 18 and 22 degrees and women are usually at the higher end of this range due to having a wider pelvis.</li>
                  <li>A Q-angle increase is significant because it places increased stress on the knee joint and it’s also been linked to increased foot pronation (rotational movement) in women.The fact that the q-angle is more pronounced in women than men leads to more stress on the knee joint and makes it less stable when put under stress. This is the reason why women who participate in sports involving, running, jumping and pivoting, are probably more likely to suffer an ACL tear.</li>
                  <li>An abnormal Q-angle becomes even more complicated when it presents with a functional or anatomical short leg. Runners often suffer from short leg syndrome, but this “short leg” really isn’t “short.” It only appears that way because of a structural defect, such as an abnormal Q-angle.</li>
                </ol>
              </div>
            </div>
          </div>
