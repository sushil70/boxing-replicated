  ...
  <div className="news_articles_content" style={{width: '100%'}}>
    <div className="left_content_area" style={{margin: 0}}>
      <h1 className="titles_article border_titles_article1">
        Boxing workout            <div className="socialInfo">
          <div className="left">mvpboxing&nbsp;|&nbsp;<i className="fa fa-clock-o" aria-hidden="true" />&nbsp;August 23, 2019, 06:18PM              </div>
          <div className="clear" />
        </div>{/* ends (.socialInfo) */}
      </h1>
      <div className="workout_content update-workout_content headline-articles" style={{minHeight: 667}}>
        <div style={{margin: '25px 0 25px 0'}}>
          <img src="/assets/img/2d1377d7030b3821b2f7d2d8a70118dd.png" style={{width: '100%', height: 'auto'}} />
        </div>
        <div id="accordion" className="accordion">
          <div className="card mb-1">
            ...
            <div id="collapse0" className="collapse show" aria-labelledby="heading0" data-parent="#accordion">
              <div className="card-body">
                <p>Boxing (pugilism) is a combative sport in which two combatants, generally of similar weight fight each other with their fists. Boxing is supervised by a referee and is typically engaged in during a series of three-minute intervals called rounds with a one minute rest period (recovery) in between each round.</p>
                <p>There are various ways victory is achieved in a boxing match: When an opponent is knocked down and unable to rise to his feet before the referee counts to ten seconds or is unconscious (a Knockout or KO) or if the opponent is deemed too injured to continue (a Technical Knockout, or TKO). Because boxing is subjective in nature and is scored on a point system, then if a bout goes the entire distance, a winner is then determined by 3 independent judges' scorecards. Presently in the United States, there is no federal commission to regulate or oversee professional prize fighting, this has caused a lack of uniformity that currently exists among all boxing commissions regarding the rules, regulations and medical requirements. Generally bouts take place in a "ring" that is 18 to 24 square feet in length and is enclosed on each side by four strands of rope.</p>
                <p>The ancient Greeks provide us our first historical records of boxing as a sport; they codified a set of rules and staged tournaments with professionals. Boxing became an official sport of the Olympic game as early as 688 B.C., 23rd Olympiad. The modern era of boxing evolved in Great Britain, in 1866 the 9th Marques of Queensberry gave his support to a new set of rules, which were named in his honor. The Marques of Queensberry rule is a code of generally accepted rules in the sport of boxing. They are intended for use in both professional and amateur boxing matches. These rules limit the number of 3- minute rounds, eliminated wrestling tactics, and made the use of boxing gloves mandatory.</p>
                <p>Because of the intense activity of boxing, it is very important for the fighters to be highly conditioned, both physically and mentally. A fighter entering the ring in anything but a high level of physical conditioning can expect, at the very least, to be knocked unconscious and increases the risk of serious injury, or death if ill prepared.</p>
                <p>Listed are the various boxing rules: Boxers are prohibited from hitting below the belt (groin area), holding, tripping, pushing, biting, spitting, or wrestling. They are not allowed to kick, head-butt, or hitting with any part of the arm other than the knuckles of a closed fist (including hitting with the elbow, shoulder or forearm, as well as with open gloves, the wrist, the inside, back or side of the hand). They are prohibited as well from hitting the back, back of the neck or head (rabbit-punch) or the kidneys and are prevented from holding the ropes for support when punching, and holding an opponent while punching. A "clinch" -- a defensive tactic in which a boxer wraps his/her opponents arms with the sole intention being to prevent from being hit - once the referee separates the fighters, each fighter must take a full step back before fighting is resumed ( referee has the power to direct the fighters to "punch out" of the clinch). When a boxer is knocked down by a punch, his/her opponent must immediately cease fighting and go to the nearest neutral corner of the ring until the referee has either ruled a knockout or requested for the fight to continue.</p>
              </div>
            </div>
          </div>
          <div className="card mb-1">
          ...
          <div className="card mb-1">
            ...
            <div id="collapse5" className="collapse" aria-labelledby="heading5" data-parent="#accordion">
              <div className="card-body">
                <p>When intense activity is continued for about ninety seconds, glycogen is used as an energy source. When the glycogen is broken down, more ATP is produced. However, if the activity is intense (anaerobic),there will not be enough oxygen supplied to the muscles. When glycogen is burned in the absence of oxygen, lactic acid is produced. Once lactic acid is formed, it diffuses into the blood and is transported to different areas of the body. This allows the working muscle to continue. Eventually, the lactic acid level will accumulate to a level that will slow down the biochemical reactions that lead to the production of ATP. Accumulation of lactic acid causes pain and burning sensations in the stressed muscles. Shortly thereafter, contraction will not be able to take place.</p>
              </div>
            </div>
          </div>
          <div className="card mb-1">
          ...
          <div className="card mb-1">
            ...
            <div id="collapse7" className="collapse" aria-labelledby="heading7" data-parent="#accordion">
              <div className="card-body">
                <p>During the recovery period of training, the ATP-CP must be built-up and replenished and the accumulated lactic acid must be removed. If these needs aren't met, the systems will be un-available for further activity. While resting after an anaerobic work bout, oxygen consumption is increased because of the increased depth and rate of breathing. This extra oxygen turns the lactic acid back to pyruvic acid and within 20 seconds, 50% of the ATP and CP is restored, in 40 seconds, 75% is restored and in 60 seconds, 87% is restored. Almost all of the ATP and CP are replenished within three minutes. The removal rate of lactic acid is slower then the rebuilding rate of ATP and CP. In 25 minutes, 50% of the lactic acid will be removed, in 50 minutes, 75% and 87% in 75 minutes. The removal rate of lactic acid can be sped up through light activity performed during the recovery period. This is because some of the lactic acid is metabolized aerobically during the light activity.</p>
              </div>
            </div>
          </div>
          <div className="card mb-1">
            ...
            <div id="collapse8" className="collapse" aria-labelledby="heading8" data-parent="#accordion">
              <div className="card-body">
                <p>The rest interval is very important. The work rest ratio in Appendix A has been designed according to physiological guidelines. If the rest period is too brief, the ATP and CP will not be sufficiently replenished and the accumulated lactic acid will not be adequately removed. The next bout of exercise would have to be performed at a lower intensity. If the rest period is too long, the body will recover and the training effect will be lost.</p>
              </div>
            </div>
          </div>
          <div className="card mb-1">
          ...
          <div className="card mb-1">
            ...
            <div id="collapse10" className="collapse" aria-labelledby="heading10" data-parent="#accordion">
              <div className="card-body">
                <p>The first step is to determine the resting heart rate (RHR). The best results are obtained early in the morning immediately upon awakening. A reliable RHR is obtained by averaging the results of three mornings in a row. The HR may be taken by placing fingers on the carotid artery on the side of the neck, the temporal artery in front of the ear (temple) or at the radial artery at the base of the thumb. A good estimation of the HR is to count the pulse for 10 or 15 seconds and multiply by 6 or 4, respectively. This will give the HR in beats per minute (bpm). If the pulse was counted 18 times in 15 seconds, the RHR is 72 bpm (18x4=72 bpm).</p>
              </div>
            </div>
          </div>
          <div className="card mb-1">
            ...
            <div id="collapse11" className="collapse" aria-labelledby="heading11" data-parent="#accordion">
              <div className="card-body">
                <p>The maximum heart rate (MHR) is needed to calculate the HR at which the workload should be performed. The direct method of determining MHR is to monitor the HR of a subject running to exhaustion on a treadmill. An easier way is to subtract age from 220. A 20 year old athlete will have a MHR of 200 bpm (220- 20=200).</p>
              </div>
            </div>
          </div>
          <div className="card mb-1">
            ...
            <div id="collapse12" className="collapse" aria-labelledby="heading12" data-parent="#accordion">
              <div className="card-body">
                <p>The training heart rate (THR) is the HR at which the workload should be performed to obtain a desired physiological response. The desired percentage of MHR is multiplied by MHR to determine the THR. If the same 20 year old athlete is to perform a workout that calls for an intensity at 70% of MHR, the THR would be 140 bpm (200x.70=140 bpm).</p>
              </div>
            </div>
          </div>
          <div className="card mb-1">
          ...
          <div className="card mb-1">
            ...
            <div id="collapse15" className="collapse" aria-labelledby="heading15" data-parent="#accordion">
              <div className="card-body">
                <p>In one, three minute Thai-boxing round, a fighter will receive approximately 30% of his energy from the ATP-CP system, 5% from the aerobic system and 65% from the lactic acid system. The amount of training in each system should closely reflect these percentages. Appendix A contains the Focus-pad workouts. The chart is used in the following manner:</p>
                <ul className="pl-1">
                  <li><i className="fa fa-check-square-o" aria-hidden="true" />&nbsp;Determine what system needs to be trained and locate it in the Systems column.</li>
                  <li><i className="fa fa-check-square-o" aria-hidden="true" />&nbsp;Read across the row and make a note of how long each round is and the amount of rest between rounds.</li>
                  <li><i className="fa fa-check-square-o" aria-hidden="true" />&nbsp;Take the value in the % Max HR column and plug it into the THR formula. If the column gives two values, calculate the THR for each.</li>
                </ul>
                <p>The results are termed the training-sensitive zone. This zone will give optimal physiological results for the system picked. Following the same principles (system, work rest ratio, % max HR, etc.) many other training methods can be devised. Other methods of training can be used with the chart as well. Some other methods of training that are also important to boxing include running (especially sprints), heavybag, speedbag,double-end bag, sparring, jump- rope, shadow-boxing, plyometrics, tubing, swiss ball, kettle bell, medicine ball training, and focus mitts.</p>
              </div>
            </div>
          </div>
          <div className="card mb-1">
            <a className="text-left header" data-toggle="collapse" data-target="#collapse16" aria-expanded="true" aria-controls="collapse16">
            ...
            <div id="collapse16" className="collapse" aria-labelledby="heading16" data-parent="#accordion">
              <div className="card-body">
                <p>The cool-down is post-activity exercise done in a continuous, easy, relaxing manner. The cool-down helps the body return to a normal resting state. It also decreases DOMS (Delayed Onset of Muscle Soreness), helps to alleviate the pooling of blood in the lower extremities and increases the removal rate of accumulated lactic acid.</p>
              </div>
            </div>
          </div>
          <div className="card mb-1">
            <a className="text-left header" data-toggle="collapse" data-target="#collapse17" aria-expanded="true" aria-controls="collapse17">
            ...
            <div id="collapse17" className="collapse" aria-labelledby="heading17" data-parent="#accordion">
              <div className="card-body">
                <p>Strength and muscle endurance are important components in boxing. Strength is the amount of force that can be exerted by a muscle group for one movement. Muscle endurance is the ability of a muscle to contract over a period of time. The advantages of these two traits is obvious when applied to boxing. Many trainers of Western boxing feel that weight training will make the athlete muscle bound and slow them down. All research conclusively demonstrates that a properly designed and implemented boxing specific program will increase speed and power. Take a look at the World Record holder in the 100 meters. Leroy Burrell is obviously a fan of weight training. Is Manny Pacquiao slow?</p>
                <p>Weight training can increase both muscular endurance and strength. There are four basic principles to follow while on a weight- resistance training program:</p>
                <ul className="pl-1">
                  <li><i className="fa fa-check-square-o" aria-hidden="true" />&nbsp;Overload-forcing the muscles to contract at near maximum levels. Through overload, the muscle will be forced to adapt.</li>
                  <li><i className="fa fa-check-square-o" aria-hidden="true" />&nbsp;Progressive resistance-the training load must be progressively increased to cause overload to the muscle.</li>
                  <li><i className="fa fa-check-square-o" aria-hidden="true" />&nbsp;Specificity-the muscle adaptations are specific to the type of training done. Therefore, the same muscles used in Thai-boxing need to be stressed while weight training.</li>
                  <li><i className="fa fa-check-square-o" aria-hidden="true" />&nbsp;Recovery-a muscle fatigued from the effects of weight training needs 48 hours recovery before resistance training is repeated.</li>
                </ul>
                <br />
                <p>To determine the proper amount of resistance to train with, a 1 repetition max (RM) is used. One RM is the maximum load that can be moved through the full range of motion for 1 repetition. A percentage of this 1 RM is then taken to determine a training weight. While lifting, the concentric contraction (shortening of the muscle and decrease in angle of a joint) should be performed in 1-2 seconds. The eccentric contraction (lengthening of the muscle and increase in the angle of the joint) should last 4 seconds. For example, while performing a barbell biceps curl, the weight is lifted up in 1-2 seconds and lowered in 4 seconds.</p>
              </div>
            </div>
          </div>
          <div className="card mb-1">
            <a className="text-left header" data-toggle="collapse" data-target="#collapse18" aria-expanded="true" aria-controls="collapse18">
            ...
            <div id="collapse18" className="collapse" aria-labelledby="heading18" data-parent="#accordion">
              <div className="card-body">
                <p>Periodization is based on the theory that hard, high intensity work over extended periods of time can lead to burnout, injury and stagnation. Better progress can be made following a periodization schedule. The periodization cycle can be found in Appendix D for weight training and in Appendix E for Focus-pads.</p>
              </div>
            </div>
          </div>
          <div className="card mb-1">
            <a className="text-left header" data-toggle="collapse" data-target="#collapse19" aria-expanded="true" aria-controls="collapse19">
            ...
            <div id="collapse19" className="collapse" aria-labelledby="heading19" data-parent="#accordion">
              <div className="card-body">
                <p>By following this scientifically based training program, you can be assured of making optimal results. The main objective is to be consistent with it. On days you feel like skipping the workout, remind yourself of your goals. Its better to decrease the intensity and do the workout then to not do it at all. The #l reason for quitting an exercise program was given in a survey: The participants perceived the training as too hard. There is no better way to discourage a new exerciser then to crush their enthusiasm with a killer workout. There is no need to jump into a new program head first. Take your time, set short &amp; long term goals, and you will be on the path to success.</p>
              </div>
            </div>
          </div>
          <div className="card mb-1">
            <a className="text-left header" data-toggle="collapse" data-target="#collapse20" aria-expanded="true" aria-controls="collapse20">
          ...
          <div className="card mb-1">
            ...
            <div id="collapse20" className="collapse" aria-labelledby="heading20" data-parent="#accordion">
              <div className="card-body">
                <p>8 seconds easy, 8 seconds full speed, 24 seconds. rest, 4 rounds. 1 minute rest</p>
              </div>
            </div>
          </div>
          <div className="card mb-1">
            <a className="text-left header" data-toggle="collapse" data-target="#collapse21" aria-expanded="true" aria-controls="collapse21">
            ...
            <div id="collapse21" className="collapse" aria-labelledby="heading21" data-parent="#accordion">
              <div className="card-body">
                <p>10 seconds full speed, 30 seconds rest, 4 rounds. 3 minutes rest.</p>
              </div>
            </div>
          </div>
        </div>
        <p>Written and researched by:&nbsp;<strong>Tim Mousel</strong></p>
      </div>{/* ends (.workout_content) */}
      <div className="page__links" style={{marginBottom: 10}}>
        <h3 className="page__links__title" />
        <Link className="page__links__link btn feat-link" target="_self" to="/contact-us">
