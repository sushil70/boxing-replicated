  ...
  <div className="news_articles_content" itemScope itemType="https://schema.org/Article" style={{width: '100%'}}>
    <div className="left_content_area" style={{margin: 0}}>
      <h1 className="titles_article border_titles_article1">
        <span itemProp="name">Brazilian Jiu-Jitsu: Martial Art, Combat Sport, Self-Defense | MVP Boxing</span>            <div className="socialInfo">
          <div className="left">mvpboxing                                    &nbsp;|&nbsp;
            <i className="fa fa-clock-o" aria-hidden="true" />&nbsp;March 28, 2018, 07:56PM              </div>
          <div className="clear" />
        </div>{/* ends (.socialInfo) */}
      </h1>
      <div className="workout_content update-workout_content">
        <div style={{margin: '25px 0 25px 0'}}>
          <img src="/assets/userfiles/images/bjj.jpg" style={{width: '100%', height: 'auto'}} />
        </div>
        <div id="accordion" className="accordion">
          <div className="card mb-1">
            ...
            <div id="collapse0" className="collapse show" aria-labelledby="heading0" data-parent="#accordion">
              <div className="card-body">
                <p>Brazilian Jiu-Jitsu is a martial art, combat sport, and a form of self-defense that focuses on grappling and ground fighting. It promotes the principle that a smaller, physically weaker individuals can successfully defend themselves against a bigger, stronger assailant using leverage and proper technique; most notably, by applying joint-locks and chokeholds to defeat them.</p>
                <p>Brazilian Jiu Jitsu (BJJ) has become one of the most in demand martial art due to its usage in the MMA competition. At Masson Academy you’re welcome to train amongst the best instructors and students no matter your level of expertise.</p>
              </div>
            </div>
          </div>
          <div className="card mb-1">
            ...
            <div id="collapse1" className="collapse" aria-labelledby="heading1" data-parent="#accordion">
              <div className="card-body">
                <p>The new student will engage in a learning journey based in the origins of Brazilian Jiu-Jitsu and learn the most effective ground self-defense system.</p>
              </div>
            </div>
          </div>
          <div className="card mb-1">
            ...
            <div id="collapse2" className="collapse" aria-labelledby="heading2" data-parent="#accordion">
              <div className="card-body">
                <p>The young student will embark on a fun and motivational journey exploring the fundamentals of Brazilian Jiu-Jitsu while gaining self-respect, confidence and leadership skills.</p>
              </div>
            </div>
          </div>
          <div className="card mb-1">
          ...
          <div className="card mb-1">
            ...
            <div id="collapse4" className="collapse" aria-labelledby="heading4" data-parent="#accordion">
              <div className="card-body">
                <p>Purple Belt</p>
                <p>Masson Advanced Curriculum is primarily focused on competition BJJ with the Gi. If the student would like to train self-defense they may come to the fundamentals classes, until of Blue belt is attained.</p>
              </div>
            </div>
          </div>
          <div className="card mb-1">
            ...
            <div id="collapse5" className="collapse" aria-labelledby="heading5" data-parent="#accordion">
              <div className="card-body">
                <p>Black Belt</p>
                <p>This program is built upon three different curriculums: BJJ, BJJ No-Gi, and BJJ for MMA. The student will consolidate his/her Jiu-Jitsu expertise and complete the path towards their Black belt. All new students must undergo an evaluation by a black belt professor (Intro class) whom will make a professional recommendation to which program the student should enroll.</p>
              </div>
            </div>
          </div>
          <div className="card mb-1">
            ...
            <div id="collapse6" className="collapse" aria-labelledby="heading6" data-parent="#accordion">
              <div className="card-body">
                <p>Your progress is a direct consequence of your efforts. At Masson Academy, Belts or Stripes are not given, they are earned. Progress will be carefully evaluated and monitored by our instructors board.</p>
                <br />
                <p>For any further information regarding Masson Academy programs please visit the academy in person and speak with a program director.</p>
              </div>
            </div>
          </div>
